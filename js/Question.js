class Question {
  ...
  display(){
    ...
    this.question.html("Question:- The Naxcivan Autonomous Republic and the Nagorno-Karabekh regions are disputed by what two countries?" );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Vantuatu and Fiji " );
    this.option1.position(150, 100);
    this.option2.html("2: Iran and Turkey" );
    this.option2.position(150, 120);
    this.option3.html("3: Armenia and Azerbaijan " );
    this.option3.position(150, 140);
    this.option4.html("4: Russia and Kazakhstan" );
